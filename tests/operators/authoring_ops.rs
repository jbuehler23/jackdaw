...
const ENTITY_PARAM_OPS: &[(&str, &[&str], bool)] = &[
    ...
    ("clip.select", &["entity"], true),
    ("clip.track.enable", &["track"], false),
    ("clip.track.interpolation", &["track"], false),
    ...
    ("prefab.pack", &["entity"], true),
    ("prefab.pack_matching", &["entity"], true),
