...
pub fn remove_doubles(bmesh: &mut BMesh, distance: f32) -> Result<MergeResult, MergeError> {
    ...
    // Step 4: Flatten current BMesh to topology.
    ...
    // Step 7: Rebuild BMesh from cleaned topology.
    ...
    *bmesh = BMesh::lift_from_topology(&new_topology);
