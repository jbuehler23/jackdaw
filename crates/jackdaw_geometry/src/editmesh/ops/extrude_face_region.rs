...
//!
//! Inspired by Blender's BMO_OP_extrude_face_region (algorithmic reference); implementation
//! original. Single-face MVP -- multi-face region merging deferred.
...
pub fn extrude_face_region(
    ...
    for i in 0..n {
        top_loops.push(bmesh.loops.insert(EditLoop {
            vert: new_verts[i],
            edge: top_edges[i],
            face,
    ...
    for i in 0..n {
        ...
        let side_face = bmesh.faces.insert(EditFace {
            flag: FaceFlag::empty(),
        ...
        let l1 = bmesh.loops.insert(EditLoop {
        ...
        let l2 = bmesh.loops.insert(EditLoop {
        ...
        let l3 = bmesh.loops.insert(EditLoop {
            vert: new_verts[i],
            edge: wall_edges[i],
            face: side_face,
            next: LoopKey::default(),
    ...
    bmesh.faces[face].loop_first = top_loops[0];
